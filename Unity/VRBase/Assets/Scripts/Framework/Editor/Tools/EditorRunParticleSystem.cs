...
public class EditorRunParticleSystem : Editor
{
    /// <summary>
    /// 滑动杆的当前时间
    /// </summary>
    ...
    {
        get { return m_ParticleSystem ?? (m_ParticleSystem = editAnimator.GetComponentsInChildren<ParticleSystem>()); }
    }
    ...
    private void update()
    {
        ...
        {
            if(ps)
            ps.Simulate(m_RunningTime, true);
        }
